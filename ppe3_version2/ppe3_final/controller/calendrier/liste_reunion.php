...
foreach ($requete as $req)
{
    ...
    if($req['RE_Organisateur'] == $login)
        {
            echo "<td><form action='../../view/page_menu/description_reunion.php' method='post'><input type='hidden' name='modif_user' value=" .$req['ID_DIS']."><button type='submit' class='btn btn-success'> Modifier</button></form></td>";
