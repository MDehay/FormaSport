...
echo "<td><form action='supprimer_reunion.php' method='post'><input type='hidden' name='del_id_re' value=".$Donnee['NumeroReunion']."><button type='submit' class='btn btn-danger'> Supprimez Reunion </button></form> </td>";
